var skel = function () {
    var e = "config", t = "breakpoints", n = "iterate", r = "elements", i = "getCachedElement", s = "stateId",
        o = "getElementsByClassName", u = !1, a = "stateElements", f = "cacheElement", l = "deviceType", c = "length",
        h = "getElementsByTagName", p = "parentNode", d = null, v = "match", m = "config_breakpoint",
        g = "orientationChange", y = "newInline", b = "insertBefore", w = "vars", E = "object", S = "cache",
        x = "lockState", T = "!important", N = "head", C = "containers", k = "createElement", L = "_skel_isReversed",
        A = "className", O = "locations", M = "extend", _ = "}", D = " 0 0 ", P = "replace", H = "indexOf", B = !0,
        j = "onorientationchange", F = "isArray", I = "location", q = "DOMReady", R = "devicePixelRatio", U = "push",
        z = "addEventListener", W = "{display:none!important}", X = "parseMeasurement", V = "registerLocation",
        $ = "padding-top:0!important", J = "defaults", K = "events", Q = "substring", G = "^head", Y = "hasOwnProperty",
        Z = "android", et = "viewportWidth", tt = "DOMContentLoaded", nt = "getDevicePixelRatio", rt = "string",
        it = "IEVersion", st = "matchMedia", ot = "states", ut = "_skel_attach", at = "ios", ft = "ignoreOrientation",
        lt = "placeholder", ct = "removeEventListener", ht = "padding-top:", pt = "attached", dt = "resize",
        vt = "documentElement", mt = ".row", gt = "_skel_placeholder", yt = "href", bt = "stateChange",
        wt = "firstChild", Et = "querySelectorAll", St = "windows", xt = "getViewportWidth", Tt = "previousSibling",
        Nt = "prototype", Ct = "gutters", kt = "innerHTML", Lt = "text/css", At = "domready", Ot = "html",
        Mt = "padding:", _t = "attachElements", Dt = "priority", Pt = "attachElement", Ht = ".\\3$1 ", Bt = "collapse",
        jt = "onresize", Ft = "readyState", It = {
            config: {
                containers: 960,
                pollOnce: u,
                pollOnLock: u,
            ...
            initUtilityMethods: function () {
                document[z] ? !function (e, t) {
                    ...
                    var n = [], r, i = !1, s = document, o = s[vt], u = o.doScroll, a = tt, f = z, l = "onreadystatechange",
                        c = Ft, h = u ? /^loaded|^c/ : /^loaded|c/, p = h.test(s[c]);
